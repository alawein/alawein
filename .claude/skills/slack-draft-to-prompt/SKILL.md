...
Rewrite informal text into one packed prompt. Preserve intent. Do not add
scope, new bots, or channel changes.

Canonical templates:
[`docs/governance/slack-agent-voice.md`](../../../docs/governance/slack-agent-voice.md)
section "Draft-to-prompt pack".
