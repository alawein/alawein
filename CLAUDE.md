...
9. `README.md` in this repo is generated by `scripts/catalog/sync-readme.py`; do not
   hand-edit it.
10. For changed governed Markdown, update the freshness field required by the
    [documentation contract](docs/governance/documentation-contract.md):
    `last-verified` for `AGENTS.md`, `CLAUDE.md` and `SSOT.md`, `last-updated`
    for `LESSONS.md`, and `last_updated` for other governed documents. Keep
    exempt README entrypoints frontmatter-free.
...
- Workspace prompt: [`prompt-kits/AGENT.md`](prompt-kits/AGENT.md) 1.8.3.
