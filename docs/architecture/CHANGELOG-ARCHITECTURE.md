...
- `@alawein/typescript-config` - Shared TypeScript configurations (base, react,
  node)
...
- `@alawein/monitoring` - Monitoring utilities (Sentry, analytics, health
  checks)
...
- Comprehensive architecture review
  (`docs/architecture/ARCHITECTURE-REVIEW-2025.md`)
...
- [Workspace Setup](../governance/WORKSPACE-SETUP.md)
