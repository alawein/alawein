...
| **SimCore**      | ✅ Active            | `organizations/alawein-technologies-llc/simcore/`    | Integration ready    |
| **QMLab**        | ✅ Active            | `organizations/alawein-technologies-llc/qmlab/`      | Integration ready    |
| **Attributa**    | ✅ Active            | `organizations/alawein-technologies-llc/attributa/`  | Integration ready    |
| **LLMWorks**     | ✅ Active            | `organizations/alawein-technologies-llc/llmworks/`   | Integration ready    |
| **LiveItIconic** | ✅ Active            | `organizations/live-it-iconic-llc/liveiticonic/`     | Integration ready    |
| **REPZ**         | ✅ **ACTIVE**        | `organizations/repz-llc/repz/`                       | **Already deployed** |
| **MEZAN**        | ⚠️ Backend only      | `organizations/alawein-technologies-llc/mezan/`      | Frontend needed      |
| **TalAI**        | ⚠️ Documentation     | `organizations/alawein-technologies-llc/talai/`      | Frontend needed      |
| **DrMAlowein**   | ❌ **TO BE CREATED** | `organizations/alawein-technologies-llc/drmalowein/` | Full development     |
| **Rounaq**       | ❌ **TO BE CREATED** | `organizations/alawein-technologies-llc/rounaq/`     | Full development     |
...
```text
organizations/alawein-technologies-llc/drmalowein/
...
```text
organizations/alawein-technologies-llc/rounaq/
...
export const academicContentTaxonomy = {
  ...
  teaching: {
    courses: ['undergraduate', 'graduate', 'seminar', 'workshop'],
    materials: ['syllabus', 'lecture-notes', 'assignments', 'exams'],
  },

  achievements: {
    types: ['award', 'grant', 'fellowship', 'recognition'],
...
export const fashionContentTaxonomy = {
  products: {
    categories: ['clothing', 'accessories', 'footwear', 'handbags', 'jewelry'],
    subcategories: {
  ...
  collections: {
    types: ['seasonal', 'capsule', 'bridal', 'ready-to-wear'],
    metadata: {
      name: 'string',
      theme: 'string',
      season: 'string',
  ...
  style_content: {
    types: ['lookbook', 'style-guide', 'trend-report', 'designer-story'],
    media: {
      images: 'array',
      videos: 'array',
      moodboards: 'array',
