...
| S1 | @Cursor channels | pass (partial) | IDE lists 7/7; Cloud Agent reads 4 (admin-ops, kohyr-dev, all-alawein-workspace, posts 14:59) | 2026-09-05 |
...
| Cursor channel read | admin-ops only | Cloud reads 4; IDE lists 7 | S1 + Lane D `#posts` 14:59 |
| YAML | pre-hardening | refreshed 2026-09-05T15:00:00Z | `catalog/agent-integrations.yaml` |
