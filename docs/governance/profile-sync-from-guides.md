...
| File | Role |
|------|------|
| `profile-from-guides.yaml` | Generated by guides; gitignored in alawein. Do not edit by hand; re-export from guides to update. |
...
- Profile sync is **optional**: CI and contributors who do not have guides or the exported YAML can still run `sync-readme.py --check`; it will only validate the profile section when `profile-from-guides.yaml` exists.
