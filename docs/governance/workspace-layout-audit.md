...
| `qmatsim/` | Python research repo | mixed | Uses top-level domain directories like `qmatsim/`, `lammps/`, and `siesta/` instead of a `src/` package boundary | Plan a dedicated normalization pass before further expansion |
