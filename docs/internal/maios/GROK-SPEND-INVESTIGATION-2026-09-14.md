...
Do not invent a spend-optimizer bot. Skills beat new durable bots.
...
3. Fleet scans: Job B > Job A under freeze. One short Job B triage by
   default. Job A full scan max 1x/day unless `Force Grok:`.
