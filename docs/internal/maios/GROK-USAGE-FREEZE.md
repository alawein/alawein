...
- Kill-switch: `MAIOS_PANEL_KILL=1`. Smoke and
  `scripts/ops/openrouter_route.py` execution paths no-op before they
  load a key. `--list-routes` and workflow plan-only still run.
