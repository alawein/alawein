---
title: Portfolio Conformance Execution: implementation plan
date: 2026-06-20
status: completed
type: implementation-plan
source_spec: docs/internal/specs/2026-06-19-portfolio-conformance-map-design.md
last_updated: 2026-07-07
---

# Portfolio Conformance Execution Implementation Plan

> Status note (2026-07-07): executed. Helios lives at `_archive/2026-06-helios`
> (bucket research, type archive), Adil and Provegate are retyped to research,
> and Attributa/LLMWorks sit in the ventures bucket in `catalog/repos.json`.
