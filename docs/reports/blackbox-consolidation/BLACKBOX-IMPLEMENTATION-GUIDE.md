...
## 🎯 Purpose
This guide provides step-by-step instructions for Blackbox AI to execute the complete repository consolidation using the 21 prompts in `.config/ai/superprompts/`.
