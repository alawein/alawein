...
2. **deploy-production.yml** - Production deployments (consolidate deploy.yml, deploy-llmworks.yml, deploy-pages.yml)
3. **governance.yml** - All governance checks (consolidate 7 governance workflows)
...
**Time**: 1 hour 40 minutes (40 minutes over estimate due to thorough implementation)
