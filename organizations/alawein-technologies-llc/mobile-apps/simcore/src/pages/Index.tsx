              ...
              <div className="relative p-8 md:p-12">
                        ...
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <Button 
                              variant="outline" 
                              size="sm" 
                              onClick={() => window.open('https://github.com/alawein/QubeML', '_blank', 'noopener,noreferrer')}
                ...
                <div className="mt-8 pt-6 border-t border-border/30">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {[
                      { name: "📘 QubeML", desc: "Educational quantum computing + materials informatics framework", url: "https://github.com/alawein/QubeML" },
                      { name: "🔷 QMatSim", desc: "DFT + MD pipeline for flat-band treasure hunting", url: "https://github.com/alawein/QMatSim" },
                      { name: "🧮 SciComp", desc: "Physics in multiple dialects (multilingual simulations)", url: "https://github.com/alawein/SciComp" },
                      { name: "🌀 SpinCirc", desc: "SPICE-compatible simulator for not-yet-obsolete device concepts", url: "https://github.com/alawein/SpinCirc" },
                      { name: "🧲 MagLogic", desc: "Modeling toolkit for spin-based mischief", url: "https://github.com/alawein/MagLogic" },
