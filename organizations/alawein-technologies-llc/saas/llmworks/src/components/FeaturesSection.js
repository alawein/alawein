...
var FeatureCard = (0, react_1.memo)(function (_a) {
    ...
    (0, react_1.useEffect)(function () {
        var handleMouseMove = function (e) {
            ...
            cardRef.current.style.setProperty('--mouse-x', "".concat(x, "px"));
            cardRef.current.style.setProperty('--mouse-y', "".concat(y, "px"));
        };
    ...
    return (<div ref={cardRef} className="card-sophisticated group magnetic-hover" style={{
            animationDelay: "".concat(index * 120, "ms"),
            '--mouse-x': '50%',
            '--mouse-y': '50%'
        }} role="article" aria-labelledby={"feature-".concat(index, "-title")}>
      {/* Gradient Border Effect */}
      <div className={"absolute inset-0 rounded-xl bg-gradient-to-br ".concat(feature.gradient, " opacity-0 group-hover:opacity-100 transition-opacity duration-500")}></div>
      ...
      <div className="relative flex flex-col items-center text-center p-8 h-full">
        ...
        <div className="relative mb-8">
          <div className="glass-subtle p-6 rounded-2xl group-hover:scale-110 transition-all duration-500">
            <IconComponent className="h-10 w-10 text-primary transition-all duration-500 group-hover:rotate-12 group-hover:scale-110" aria-hidden="true"/>
          </div>
          
          {/* Floating Badge */}
          <badge_1.Badge className="absolute -top-3 -right-3 glass-panel border-0 text-xs px-3 py-1 font-semibold animate-pulse" style={{
        ...
        <h3 id={"feature-".concat(index, "-title")} className="heading-refined text-xl mb-4 group-hover:text-primary transition-colors duration-300">
          {feature.title}
        </h3>
        ...
        {/* Hover Glow Effect */}
        <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-20 transition-all duration-500 pointer-events-none" style={{
...
exports.FeaturesSection = (0, react_1.memo)(function () {
    return (<section className="relative py-32 overflow-hidden section-angled" aria-labelledby="features-heading" style={{
      ...
      <div className="container-elegant relative z-10">
        ...
        <header className="text-center mb-20 stagger-children">
          <div style={{ '--stagger-index': 0 }}>
            <badge_1.Badge className="glass-subtle border-0 px-6 py-3 mb-8 text-sm font-medium">
              <lucide_react_1.Trophy className="h-4 w-4 mr-2 text-primary"/>
              <span className="heading-refined text-primary">Strategic Excellence</span>
            </badge_1.Badge>
          </div>
          
          <div style={{ '--stagger-index': 1 }}>
            <h2 id="features-heading" className="heading-display text-5xl md:text-6xl mb-8 max-w-4xl mx-auto">
        ...
        <div className="grid-sophisticated max-w-7xl mx-auto stagger-children" role="list" aria-label="Platform capabilities">
          {features.map(function (feature, index) { return (<div key={feature.title} role="listitem" style={{ '--stagger-index': index + 3 }}>
...
exports.FeaturesSection.displayName = 'FeaturesSection';
