...
function useAuth() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var subscription = client_1.supabase.auth.onAuthStateChange(function (_event, session) {
            var _a;
    ...
    var signIn = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, client_1.supabase.auth.signInWithPassword({
                        email: email,
                        password: password,
                    })];
                case 1:
    ...
    var signUp = function (email, password, metadata) { return __awaiter(_this, void 0, void 0, function () {
        var redirectUrl, _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var resetPassword = function (email) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    redirectUrl = "".concat(window.location.origin, "/auth/reset-password");
                    return [4 /*yield*/, client_1.supabase.auth.resetPasswordForEmail(email, {
    ...
    var updatePassword = function (newPassword) { return __awaiter(_this, void 0, void 0, function () {
        var _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, client_1.supabase.auth.updateUser({
