              ...
              {user ? (
                <>
                  ...
                  <Button
                    ...
                    className="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg font-bold text-sm whitespace-nowrap"
                  >
                    🧪 Re-run Tests
                  </Button>
                  <Button
                ...
                <>
                  ...
                  <Button
                    onClick={() => navigate('/validation')}
                    className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg font-bold text-sm whitespace-nowrap"
                  >
                    🧪 Run Tests
                  </Button>
                </>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 max-w-7xl mx-auto place-items-center">
            ...
            <GymTierCard
              ...
              onClick={() => {
                ...
                window.open('https://calendly.com/repz/in-person-training-other-gyms-if-access-all-clone', '_blank');
              }}
            />
            ...
            <GymTierCard
              ...
              buttonVariant="primary"
              onClick={() => {
                window.open('https://calendly.com/repz/in-person-training', '_blank');
              }}
            />
            ...
            <GymTierCard
              ...
              buttonVariant="primary"
              onClick={() => {
                window.open('https://calendly.com/repz/home-training', '_blank');
              }}
            />
          </div>
            ...
            <AnimatedSection animation="slide-up">
              <div className="space-y-8">
                {(() => {
                  ...
                  const categoryInfo = {
                    programs: { title: "📋 Programs", color: "blue", icon: "📋" },
                    results: { title: "📈 Results", color: "green", icon: "📈" },
                    pricing: { title: "💳 Pricing", color: "purple", icon: "💳" },
                    support: { title: "🎯 Support", color: "teal", icon: "🎯" },
                    technical: { title: "⚙️ Technical", color: "gray", icon: "⚙️" }
                  };
