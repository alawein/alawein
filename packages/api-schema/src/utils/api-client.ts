...
type GetOperationRequestBody<T> = T extends {
...
export class RepzApiClient {
  ...
  auth = {
    ...
    register: (userData: GetOperationRequestBody<ApiPaths['/auth/register']['post']>) =>
      this.post<GetOperationResponse<ApiPaths['/auth/register']['post']>>(
        '/auth/register',
        userData
      ),

    refresh: (refreshData: GetOperationRequestBody<ApiPaths['/auth/refresh']['post']>) =>
      this.post<GetOperationResponse<ApiPaths['/auth/refresh']['post']>>(
        '/auth/refresh',
        refreshData
      ),
  };
   ...
   */
  users = {
    me: () => this.get<GetOperationResponse<ApiPaths['/users/me']['get']>>('/users/me'),
   ...
   */
  subscriptions = {
    list: () => this.get<GetOperationResponse<ApiPaths['/subscriptions']['get']>>('/subscriptions'),

    create: (subscription: GetOperationRequestBody<ApiPaths['/subscriptions']['post']>) =>
      this.post<GetOperationResponse<ApiPaths['/subscriptions']['post']>>(
        '/subscriptions',
        subscription
      ),
  ...
  clientData = {
    ...
    update: (updates: GetOperationRequestBody<ApiPaths['/clients/data']['patch']>) =>
      this.patch<GetOperationResponse<ApiPaths['/clients/data']['patch']>>(
        '/clients/data',
        updates
      ),
  };
  ...
  workouts = {
    ...
    get: (workoutId: string) =>
      this.get<GetOperationResponse<ApiPaths['/workouts/{workoutId}']['get']>>(
        `/workouts/${workoutId}`
      ),

    update: (
      workoutId: string,
      updates: GetOperationRequestBody<ApiPaths['/workouts/{workoutId}']['patch']>
    ) =>
  ...
  analytics = {
    dashboard: (params?: { period?: string; metrics?: string[] }) =>
      this.get<GetOperationResponse<ApiPaths['/analytics/dashboard']['get']>>(
        '/analytics/dashboard',
        params
      ),
  };
   ...
   */
  featureFlags = {
    list: () => this.get<GetOperationResponse<ApiPaths['/feature-flags']['get']>>('/feature-flags'),
  };
