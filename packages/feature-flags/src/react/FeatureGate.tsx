...
export interface FeatureGateProps {
  ...
  when?: (result: { enabled: boolean; variant: string | null; payload: any }) => boolean;
}
...
export function VariantSwitch({
  ...
  const { enabled, loading: isLoading, error: evaluationError, variant } = useFeatureFlag(flagId);
