...
**Purpose**: Migrate all projects from local utility functions to shared
`@alawein/utils` package
...
The package is already available in the monorepo workspace. No installation
needed.
...
**Action**: Keep i18n.ts (has other functions), remove `formatDate()`, update
imports
