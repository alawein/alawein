...
def check_header(filepath, result):
    ...
    # The alawein profile README is a generated GitHub-facing artifact and is
    # explicitly exempt from frontmatter requirements by the local contract.
    if path.name == "README.md" and content.startswith(PROFILE_README_MARKER):
        result.ok()
        return
