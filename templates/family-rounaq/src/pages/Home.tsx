...
import { ArrowRight, Sparkles, Crown, Heart, Star, ShoppingBag } from 'lucide-react';
 ...
 * Family Platforms - Elegant Fashion & Lifestyle
 */
const categories = [
  { name: 'Dresses', image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=400', icon: Sparkles },
  { name: 'Jewelry', image: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400', icon: Crown },
  { name: 'Handbags', image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400', icon: ShoppingBag },
  { name: 'Accessories', image: 'https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=400', icon: Heart },
];
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-20 px-4">
          <motion.div
            ...
            className="max-w-xl"
          >
            <p className="text-primary font-medium tracking-widest mb-4">ROUNAQ</p>
            <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6">
              Elegance <span className="text-primary">Redefined</span>
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              Curated fashion and accessories for the modern woman.
              Timeless pieces crafted with love and attention to detail.
            </p>
            <Link
              to="/shop"
        ...
        <div className="relative rounded-2xl overflow-hidden bg-primary text-primary-foreground p-12 md:p-16">
          <div className="relative z-10 max-w-lg">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">
              Join the Rounaq Family
            </h2>
            <p className="text-primary-foreground/80 mb-6">
              Get exclusive access to new collections, styling tips, and 15% off your first order.
            </p>
